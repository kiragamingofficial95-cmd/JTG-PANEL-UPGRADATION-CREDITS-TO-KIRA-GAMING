    ...
    <AnimatePresence mode="wait">
      ...
      >
        <Routes location={location}>
          ...
          <Route path="/admin/extensions/:id" element={<ProtectedRoute><ExtensionPageView /></ProtectedRoute>} />
          <Route path="/extensions/:id" element={<ProtectedRoute><ExtensionPageView /></ProtectedRoute>} />
